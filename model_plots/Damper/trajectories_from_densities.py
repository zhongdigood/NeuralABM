...
from models.Damper import generate_smooth_data
...
@is_operation("Damper_densities_from_joint")
def densities_from_joint(
    ...
    *,
    ...
    """Runs the Damper ODE model with the estimated parameters, given in the xr.Dataset, and weights each time series with
