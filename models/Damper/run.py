...
Damper = import_module_from_path(mod_path=up(up(__file__)), mod_str="Damper")
...
if __name__ == "__main__":
    ...
    model_name = cfg.get("root_model_name", "Damper")
    ...
    training_data = Damper.get_Damper_data(data_cfg=model_cfg["Data"], h5group=h5group).to(
        device
    )
    ...
    if model_cfg.get("MCMC", {}).pop("perform_sampling", False):
        ...
        sampler = Damper.Langevin_sampler(
            h5File=h5file,
